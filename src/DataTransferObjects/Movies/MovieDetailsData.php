...
final readonly class MovieDetailsData
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            production_companies: $data['production_companies'] ?? null ? array_map(fn(array $company): ProductionCompanyData => ProductionCompanyData::fromArray($company), $data['production_companies']) : null,
            production_countries: $data['production_countries'] ?? null ? array_map(fn(array $country): ProductionCountryData => ProductionCountryData::fromArray($country), $data['production_countries']) : null,
