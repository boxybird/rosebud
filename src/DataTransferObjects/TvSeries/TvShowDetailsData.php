...
use Rosebud\DataTransferObjects\Movies\AlternativeTitlesData;
use Rosebud\DataTransferObjects\Movies\CreditsData;
use Rosebud\DataTransferObjects\Movies\ExternalIdsData;
use Rosebud\DataTransferObjects\Movies\GenreData;
use Rosebud\DataTransferObjects\Movies\ImagesData;
use Rosebud\DataTransferObjects\Movies\KeywordsData;
use Rosebud\DataTransferObjects\Movies\ProductionCompanyData;
use Rosebud\DataTransferObjects\Movies\ProductionCountryData;
use Rosebud\DataTransferObjects\Movies\RecommendationsData;
use Rosebud\DataTransferObjects\Movies\ReleaseDatesData;
use Rosebud\DataTransferObjects\Movies\ReleasesData;
use Rosebud\DataTransferObjects\Movies\ReviewsData;
use Rosebud\DataTransferObjects\Movies\SimilarMoviesData;
use Rosebud\DataTransferObjects\Movies\SpokenLanguageData;
use Rosebud\DataTransferObjects\Movies\TranslationsData;
use Rosebud\DataTransferObjects\Movies\VideosData;
