...
final readonly class TvShowDetailsData
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            created_by: $data['created_by'] ?? null ? array_map(fn(array $created_by) => CreatedByData::fromArray($created_by), $data['created_by']) : null,
            ...
            networks: $data['networks'] ?? null ? array_map(fn(array $network) => NetworkData::fromArray($network), $data['networks']) : null,
            ...
            seasons: $data['seasons'] ?? null ? array_map(fn(array $season) => SeasonData::fromArray($season), $data['seasons']) : null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'created_by' => $this->created_by ? array_map(fn(CreatedByData $created_by) => $created_by->toArray(), $this->created_by) : null,
            ...
            'networks' => $this->networks ? array_map(fn(NetworkData $network) => $network->toArray(), $this->networks) : null,
            ...
            'seasons' => $this->seasons ? array_map(fn(SeasonData $season) => $season->toArray(), $this->seasons) : null,
